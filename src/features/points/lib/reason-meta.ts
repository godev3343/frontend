...
import { MapPin, Sparkles, Star, UserPlus } from "lucide-react";
...
export function getReasonMeta(reason: PointsReason): ReasonMeta {
  return REASON_META[reason] ?? { label: reason, icon: Sparkles };
}
